...
public final class ActivityAddcategoryBinding implements ViewBinding {
  ...
  private ActivityAddcategoryBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout activityMain, @NonNull Button btnAdd, @NonNull Button btnList,
      @NonNull EditText edtName, @NonNull CircleImageView imageView, @NonNull TextView textView4) {
  ...
  public static ActivityAddcategoryBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_addcategory, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ActivityAddcategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddcategoryBinding((ConstraintLayout) rootView, activityMain, btnAdd,
          btnList, edtName, imageView, textView4);
    }
